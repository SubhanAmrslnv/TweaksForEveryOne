...
LoadSettings() {
    ...
    BreatheCursorEnabled := IniStr("mouse", "breathe", "0") = "1"
    ...
    BreathingEnabled := IniStr("memory", "breathing", "0") = "1"
    ...
    CopyFeedbackEnabled := IniStr("mouse", "copyfeedback", "0") = "1"
    ...
    SpotlightEnabled := IniStr("memory", "spotlight", "0") = "1"
